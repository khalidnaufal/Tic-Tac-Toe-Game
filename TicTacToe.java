...
public class TicTacToe extends JFrame implements ActionListener {
    ...
    public TicTacToe() {
        ...
        for (int i = 0; i < buttons.length; i++) {
            ...
            buttons[i].setForeground(new Color(255, 255, 225));
            buttons[i].setBackground(new Color(135, 150, 200));
            buttons[i].setFont(new Font("Garamond", Font.BOLD + Font.ITALIC, 200));
        ...
        resetButton.setFont(new Font("Arial", Font.BOLD, 80));
